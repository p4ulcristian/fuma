...
router.frontend.zero.navigate_BANG_ = (function router$frontend$zero$navigate_BANG_(p__27807){
var map__27808 = p__27807;
var map__27808__$1 = cljs.core.__destructure_map(map__27808);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27808__$1,new cljs.core.Keyword(null,"path","path",-188191168));
return accountant.core.navigate_BANG_.cljs$core$IFn$_invoke$arity$1(path);
});
router.frontend.zero.navigate_and_reload_BANG_ = (function router$frontend$zero$navigate_and_reload_BANG_(p__27809){
var map__27810 = p__27809;
var map__27810__$1 = cljs.core.__destructure_map(map__27810);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27810__$1,new cljs.core.Keyword(null,"path","path",-188191168));
accountant.core.navigate_BANG_.cljs$core$IFn$_invoke$arity$1(path);

return location.reload();
});
re_frame.core.reg_fx(new cljs.core.Keyword(null,"swap-query-params!","swap-query-params!",628859697),(function (p__27811){
var map__27812 = p__27811;
var map__27812__$1 = cljs.core.__destructure_map(map__27812);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27812__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("router","swap-query-params!","router/swap-query-params!",-357564454),(function (p__27813){
var map__27814 = p__27813;
var map__27814__$1 = cljs.core.__destructure_map(map__27814);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27814__$1,new cljs.core.Keyword(null,"params","params",710516235));
