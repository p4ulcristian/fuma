...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__27072_SHARP_){
return reitit.frontend.query_param(q,p1__27072_SHARP_);
})),q.getKeys()));
});
/**
...
var new_query = ((cljs.core.fn_QMARK_(new_query_or_update_fn))?(function (){var G__27073 = reitit.frontend.query_params(uri);
return (new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1 ? new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1(G__27073) : new_query_or_update_fn.call(null,G__27073));
...
var temp__5823__auto__ = reitit.coercion.match__GT_path.cljs$core$IFn$_invoke$arity$2(match,query_params);
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27076),"#",reitit.impl.form_encode(fragment)].join('');
} else {
return G__27076;
}
} else {
...
(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$2 = (function (router__$1,path){
return reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3(router__$1,path,null);
}));

(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3 = (function (router__$1,path,p__27079){
var map__27080 = p__27079;
var map__27080__$1 = cljs.core.__destructure_map(map__27080);
var on_coercion_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27080__$1,new cljs.core.Keyword(null,"on-coercion-error","on-coercion-error",-970787));
var uri = goog.Uri.parse(path);
var coerce_BANG_ = (cljs.core.truth_(on_coercion_error)?(function (match){
try{return reitit.coercion.coerce_BANG_(match);
}catch (e27082){if((e27082 instanceof Error)){
var e = e27082;
...
var temp__5821__auto__ = reitit.core.match_by_path(router__$1,uri.getPath());
...
(reitit.frontend.match_by_name.cljs$core$IFn$_invoke$arity$2 = (function (router__$1,name){
return reitit.frontend.match_by_name.cljs$core$IFn$_invoke$arity$3(router__$1,name,cljs.core.PersistentArrayMap.EMPTY);
}));

(reitit.frontend.match_by_name.cljs$core$IFn$_invoke$arity$3 = (function (router__$1,name,path_params){
return reitit.core.match_by_name(router__$1,name,path_params);
}));
...
(reitit.frontend.match_by_name_BANG_.cljs$core$IFn$_invoke$arity$2 = (function (router__$1,name){
return reitit.frontend.match_by_name_BANG_.cljs$core$IFn$_invoke$arity$3(router__$1,name,cljs.core.PersistentArrayMap.EMPTY);
}));

(reitit.frontend.match_by_name_BANG_.cljs$core$IFn$_invoke$arity$3 = (function (router__$1,name,path_params){
var temp__5821__auto__ = reitit.frontend.match_by_name.cljs$core$IFn$_invoke$arity$3(router__$1,name,path_params);
if(cljs.core.truth_(temp__5821__auto__)){
var match = temp__5821__auto__;
if(reitit.core.partial_match_QMARK_(match)){
if(cljs.core.every_QMARK_((function (p1__27095_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__27095_SHARP_);
