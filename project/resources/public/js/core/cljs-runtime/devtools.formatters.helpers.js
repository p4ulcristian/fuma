...
var G__13561 = devtools.prefs.pref(v);
v = G__13561;
continue;
} else {
return v;
...
}catch (e13526){var _e__12807__auto__ = e13526;
return false;
}})();
...
}catch (e13531){var _e__12807__auto__ = e13531;
return false;
}})();
...
}catch (e13538){var _e__12807__auto__ = e13538;
return false;
}}
}
});
...
var vec__13542 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13542,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13542,(1),null);
...
return cljs.core.some((function (p1__13545_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13545_SHARP_);
}),template);
});
