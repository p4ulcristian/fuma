...
var G__13466 = devtools.prefs.pref(v);
v = G__13466;
continue;
} else {
return v;
...
}catch (e13447){var _e__12856__auto__ = e13447;
return false;
}})();
...
}catch (e13449){var _e__12856__auto__ = e13449;
return false;
}})();
...
}catch (e13451){var _e__12856__auto__ = e13451;
return false;
}}
}
});
...
var vec__13456 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13456,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13456,(1),null);
...
return cljs.core.some((function (p1__13459_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13459_SHARP_);
}),template);
});
