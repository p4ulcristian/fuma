...
var G__25257 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__25257;
continue;
} else {
return ch;
...
var vec__25252 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25252,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq25255){
