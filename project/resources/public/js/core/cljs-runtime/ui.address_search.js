...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("ui","address-search","ui/address-search",-1610282242),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__38704){
var vec__38707 = p__38704;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38707,(0),null);
var component_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38707,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("ui","address-search-set-state","ui/address-search-set-state",-325756243),(function (db,p__38714){
var vec__38715 = p__38714;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38715,(0),null);
var component_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38715,(1),null);
var state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38715,(2),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("ui","address-search-update","ui/address-search-update",1967522077),(function (db,p__38722){
var vec__38723 = p__38722;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38723,(0),null);
var component_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38723,(1),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38723,(2),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38723,(3),null);
 ...
 */
ui.address_search.address_search_dropdown = (function ui$address_search$address_search_dropdown(p__38754){
var map__38757 = p__38754;
var map__38757__$1 = cljs.core.__destructure_map(map__38757);
var component_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38757__$1,new cljs.core.Keyword(null,"component-id","component-id",1551113783));
var workspace_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38757__$1,new cljs.core.Keyword(null,"workspace-id","workspace-id",-196897435));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38757__$1,new cljs.core.Keyword(null,"value","value",305978217));
var on_select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38757__$1,new cljs.core.Keyword(null,"on-select","on-select",-192407950));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38757__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38757__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
...
var component_id__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38765__$1,new cljs.core.Keyword(null,"component-id","component-id",1551113783));
var workspace_id__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38765__$1,new cljs.core.Keyword(null,"workspace-id","workspace-id",-196897435));
var value__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38765__$1,new cljs.core.Keyword(null,"value","value",305978217));
var on_select__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38765__$1,new cljs.core.Keyword(null,"on-select","on-select",-192407950));
var placeholder__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38765__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var disabled__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38765__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38789),ui$address_search$address_search_dropdown_$_iter__38786(cljs.core.chunk_rest(s__38787__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38789),null);
}
} else {
var address = cljs.core.first(s__38787__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("address","id","address/id",-555725248).cljs$core$IFn$_invoke$arity$1(address),new cljs.core.Keyword(null,"class","class",-2030961996),"address-option",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (address,s__38787__$2,temp__5823__auto__,state,search_term,addresses,loading_QMARK_,show_dropdown_QMARK_,selected_address,map__38765,map__38765__$1,component_id__$1,workspace_id__$1,value__$1,on_select__$1,placeholder__$1,disabled__$1,map__38757,map__38757__$1,component_id,workspace_id,value,on_select,placeholder,disabled){
return (function (_){
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ui","address-search-update","ui/address-search-update",1967522077),component_id__$1,new cljs.core.Keyword(null,"selected-address","selected-address",763318752),address], null));
...
});})(address,s__38787__$2,temp__5823__auto__,state,search_term,addresses,loading_QMARK_,show_dropdown_QMARK_,selected_address,map__38765,map__38765__$1,component_id__$1,workspace_id__$1,value__$1,on_select__$1,placeholder__$1,disabled__$1,map__38757,map__38757__$1,component_id,workspace_id,value,on_select,placeholder,disabled))
,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"padding","padding",1660304693),"8px 12px",new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer",new cljs.core.Keyword(null,"border-bottom","border-bottom",2110948415),"1px solid #eee"], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),"500"], null)], null),new cljs.core.Keyword("address","name","address/name",848026653).cljs$core$IFn$_invoke$arity$1(address)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"12px",new cljs.core.Keyword(null,"color","color",1011675173),"#666"], null)], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("address","address-line1","address/address-line1",-1206418180).cljs$core$IFn$_invoke$arity$1(address)),", ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("address","city","address/city",-1506334306).cljs$core$IFn$_invoke$arity$1(address))].join('')], null)], null),ui$address_search$address_search_dropdown_$_iter__38786(cljs.core.rest(s__38787__$2)));
}
} else {
return null;
}
