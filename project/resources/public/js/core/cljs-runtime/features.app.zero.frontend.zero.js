...
features.app.zero.frontend.zero.routes = cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(features.app.homepage.routes.routes,features.app.the_team.routes.routes,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([features.app.pricing.routes.routes], 0));
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [ui.header.view], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(router_data)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [zero.frontend.re_frame_viewer.view.re_frame_viewer], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [zero.frontend.re_frame_viewer.view.keyboard_listener], null)], null);
});
