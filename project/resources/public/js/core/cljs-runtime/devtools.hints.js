...
}catch (e13224){var _e = e13224;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5821__auto___13293 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5821__auto___13293)){
var seen_errors_13294 = temp__5821__auto___13293;
if(cljs.core.truth_(seen_errors_13294.has(self))){
} else {
seen_errors_13294.add(self);

var temp__5823__auto___13295 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5823__auto___13295)){
var sense_13296 = temp__5823__auto___13295;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13296)].join(''));
} else {
}
}
} else {
