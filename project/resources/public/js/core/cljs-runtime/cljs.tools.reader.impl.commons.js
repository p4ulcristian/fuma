...
var G__26858 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__26858;
continue;
} else {
return ch;
...
var vec__26852 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26852,(0),null);
return (match === s);
});
...
var G__26865 = (i__5750__auto___26863 + (1));
i__5750__auto___26863 = G__26865;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq26856){
...
return (function() { 
var G__26866__delegate = function (rdr,_){
...
var G__26866 = function (rdr,var_args){
var _ = null;
...
while (G__26867__i < G__26867__a.length) {G__26867__a[G__26867__i] = arguments[G__26867__i + 1]; ++G__26867__i;}
  _ = new cljs.core.IndexedSeq(G__26867__a,0,null);
} 
return G__26866__delegate.call(this,rdr,_);};
G__26866.cljs$lang$maxFixedArity = 1;
G__26866.cljs$lang$applyTo = (function (arglist__26868){
var rdr = cljs.core.first(arglist__26868);
var _ = cljs.core.rest(arglist__26868);
return G__26866__delegate(rdr,_);
});
