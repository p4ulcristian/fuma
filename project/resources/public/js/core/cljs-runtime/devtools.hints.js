...
var map__13166 = top_item;
var map__13166__$1 = cljs.core.__destructure_map(map__13166);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13166__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13166__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13166__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e13163){var _e = e13163;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5821__auto___13262 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5821__auto___13262)){
var seen_errors_13263 = temp__5821__auto___13262;
if(cljs.core.truth_(seen_errors_13263.has(self))){
} else {
seen_errors_13263.add(self);

var temp__5823__auto___13264 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5823__auto___13264)){
var sense_13265 = temp__5823__auto___13264;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13265)].join(''));
} else {
}
}
} else {
