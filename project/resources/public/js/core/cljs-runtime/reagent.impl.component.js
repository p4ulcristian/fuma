...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23666 = c;
var G__23666__$1 = (((G__23666 == null))?null:G__23666.prototype);
if((G__23666__$1 == null)){
return null;
} else {
return G__23666__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__23667 = c;
var G__23667__$1 = (((G__23667 == null))?null:G__23667.prototype);
if((G__23667__$1 == null)){
return null;
} else {
return G__23667__$1.render;
}
})() == null)))));
});
...
var _STAR_current_component_STAR__orig_val__23679 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__23680 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__23680);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__23679);
}});
...
var c = this;
var G__23740_23769 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__23740_23769 == null)){
} else {
reagent.ratom.dispose_BANG_(G__23740_23769);
}
...
var renders_23772 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_23773 = cljs.core.first(cljs.core.vals(renders_23772));
...
if((cljs.core.count(renders_23772) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_23772))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_23773)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_23773], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
