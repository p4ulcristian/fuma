(ns features.app.newsletter.backend.view
  (:require
...
(defn newsletter-html-page
  "Generates the HTML page for the newsletter view"
  []
  (html5
   [:head
    [:meta {:charset "UTF-8"}]
    [:meta {:name "viewport" :content "width=device-width, initial-scale=1.0"}]
    [:title "Newsletter - Fuma"]
