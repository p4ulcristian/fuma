...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18521 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18521(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_18522 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_18522(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_18525 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_18525(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_18527 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_18527(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18530 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18530(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18532 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18532(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__18519,callback){
var map__18520 = p__18519;
var map__18520__$1 = cljs.core.__destructure_map(map__18520);
var input = map__18520__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18520__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18520__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
