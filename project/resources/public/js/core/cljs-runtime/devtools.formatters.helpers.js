...
var G__13369 = devtools.prefs.pref(v);
v = G__13369;
continue;
} else {
return v;
...
}catch (e13348){var _e__12912__auto__ = e13348;
return false;
}})();
...
}catch (e13350){var _e__12912__auto__ = e13350;
return false;
}})();
...
}catch (e13352){var _e__12912__auto__ = e13352;
return false;
}}
}
});
...
var vec__13356 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13356,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13356,(1),null);
...
return cljs.core.some((function (p1__13359_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13359_SHARP_);
}),template);
});
