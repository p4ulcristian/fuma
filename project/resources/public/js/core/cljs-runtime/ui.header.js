...
var G__40117_40141 = new cljs.core.Keyword("header","set-language","header/set-language",-464045556);
var G__40118_40142 = (function (db,p__40119){
var vec__40120 = p__40119;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40120,(0),null);
var language = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40120,(1),null);
...
(zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2(G__40117_40141,G__40118_40142) : zero.frontend.re_frame.reg_event_db.call(null,G__40117_40141,G__40118_40142));
var G__40123_40143 = new cljs.core.Keyword("header","current-language","header/current-language",-2030560560);
var G__40124_40144 = (function (db,_){
...
(zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2(G__40123_40143,G__40124_40144) : zero.frontend.re_frame.reg_sub.call(null,G__40123_40143,G__40124_40144));
var G__40125_40145 = new cljs.core.Keyword("header","set-theme","header/set-theme",1813110040);
var G__40126_40146 = (function (db,p__40127){
var vec__40128 = p__40127;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40128,(0),null);
var theme = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40128,(1),null);
...
(zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2(G__40125_40145,G__40126_40146) : zero.frontend.re_frame.reg_event_db.call(null,G__40125_40145,G__40126_40146));
var G__40131_40147 = new cljs.core.Keyword("header","current-theme","header/current-theme",-1526640668);
var G__40132_40148 = (function (db,_){
...
(zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2(G__40131_40147,G__40132_40148) : zero.frontend.re_frame.reg_sub.call(null,G__40131_40147,G__40132_40148));
var G__40133_40149 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","set-language","header/set-language",-464045556),new cljs.core.Keyword(null,"hu","hu",-1762884758)], null);
(zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1(G__40133_40149) : zero.frontend.re_frame.dispatch.call(null,G__40133_40149));
var G__40134_40150 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","set-theme","header/set-theme",1813110040),new cljs.core.Keyword(null,"light","light",1918998747)], null);
(zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1(G__40134_40150) : zero.frontend.re_frame.dispatch.call(null,G__40134_40150));
...
var G__40135_40151 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","set-language","header/set-language",-464045556),new_language], null);
(zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1(G__40135_40151) : zero.frontend.re_frame.dispatch.call(null,G__40135_40151));
...
var G__40136_40152 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","set-theme","header/set-theme",1813110040),new_theme], null);
(zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1(G__40136_40152) : zero.frontend.re_frame.dispatch.call(null,G__40136_40152));
...
var current_language = (function (){var G__40137 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","current-language","header/current-language",-2030560560)], null);
return (zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1(G__40137) : zero.frontend.re_frame.subscribe.call(null,G__40137));
})();
var current_theme = (function (){var G__40138 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","current-theme","header/current-theme",-1526640668)], null);
return (zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1(G__40138) : zero.frontend.re_frame.subscribe.call(null,G__40138));
})();
...
var current_theme = (function (){var G__40139 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","current-theme","header/current-theme",-1526640668)], null);
return (zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1(G__40139) : zero.frontend.re_frame.subscribe.call(null,G__40139));
})();
var theme_colors = ui.theme.get_theme_colors(cljs.core.deref(current_theme));
...
var current_theme = cljs.core.deref((function (){var G__40140 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","current-theme","header/current-theme",-1526640668)], null);
return (zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1(G__40140) : zero.frontend.re_frame.subscribe.call(null,G__40140));
})());
