...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13483){
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13484,G__13485,seq13483__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13494_SHARP_){
return (!((cljs.core.meta(p1__13494_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13501__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13502){var _e__12856__auto__ = e13502;
return false;
}})();
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
...
}catch (e13504){var _e__12856__auto__ = e13504;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13506 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13507 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13507);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13511__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13506);
}});
...
var temp__5821__auto___13570 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5821__auto___13570)){
var managed_print_level_13571 = temp__5821__auto___13570;
var _STAR_print_level_STAR__orig_val__13514_13572 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13515_13573 = managed_print_level_13571;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13515_13573);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__13512_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13512_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13514_13572);
}} else {
job_fn();
}
