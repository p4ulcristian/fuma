...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"display","display",242065432),"grid",new cljs.core.Keyword(null,"grid-template-columns","grid-template-columns",-594112133),"repeat(auto-fit, minmax(250px, 1fr))",new cljs.core.Keyword(null,"gap","gap",80255254),"2rem",new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"3rem"], null)], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [features.app.workspace.frontend.view.feature_card,"\u2728",translations.core.tr(new cljs.core.Keyword("features","the-team","features/the-team",1822249541)),translations.core.tr(new cljs.core.Keyword("features","the-team-desc","features/the-team-desc",718558219)),"/the_team"], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [features.app.workspace.frontend.view.feature_card,"\uD83C\uDFE0",translations.core.tr(new cljs.core.Keyword("features","homepage","features/homepage",727732578)),translations.core.tr(new cljs.core.Keyword("features","homepage-desc","features/homepage-desc",1575120259)),"/"], null)], null);
});
