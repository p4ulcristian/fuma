...
router.frontend.zero.navigate_BANG_ = (function router$frontend$zero$navigate_BANG_(p__27062){
var map__27063 = p__27062;
var map__27063__$1 = cljs.core.__destructure_map(map__27063);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27063__$1,new cljs.core.Keyword(null,"path","path",-188191168));
return accountant.core.navigate_BANG_.cljs$core$IFn$_invoke$arity$1(path);
});
router.frontend.zero.navigate_and_reload_BANG_ = (function router$frontend$zero$navigate_and_reload_BANG_(p__27064){
var map__27065 = p__27064;
var map__27065__$1 = cljs.core.__destructure_map(map__27065);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27065__$1,new cljs.core.Keyword(null,"path","path",-188191168));
accountant.core.navigate_BANG_.cljs$core$IFn$_invoke$arity$1(path);

return location.reload();
});
re_frame.core.reg_fx(new cljs.core.Keyword(null,"swap-query-params!","swap-query-params!",628859697),(function (p__27066){
var map__27067 = p__27066;
var map__27067__$1 = cljs.core.__destructure_map(map__27067);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27067__$1,new cljs.core.Keyword(null,"params","params",710516235));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("router","swap-query-params!","router/swap-query-params!",-357564454),(function (p__27070){
var map__27071 = p__27070;
var map__27071__$1 = cljs.core.__destructure_map(map__27071);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27071__$1,new cljs.core.Keyword(null,"params","params",710516235));
