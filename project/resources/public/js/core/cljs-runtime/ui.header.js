...
var G__27880_27904 = new cljs.core.Keyword("header","set-language","header/set-language",-464045556);
var G__27881_27905 = (function (db,p__27882){
var vec__27883 = p__27882;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27883,(0),null);
var language = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27883,(1),null);
...
(zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2(G__27880_27904,G__27881_27905) : zero.frontend.re_frame.reg_event_db.call(null,G__27880_27904,G__27881_27905));
var G__27886_27906 = new cljs.core.Keyword("header","current-language","header/current-language",-2030560560);
var G__27887_27907 = (function (db,_){
...
(zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2(G__27886_27906,G__27887_27907) : zero.frontend.re_frame.reg_sub.call(null,G__27886_27906,G__27887_27907));
var G__27888_27908 = new cljs.core.Keyword("header","set-theme","header/set-theme",1813110040);
var G__27889_27909 = (function (db,p__27890){
var vec__27891 = p__27890;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27891,(0),null);
var theme = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27891,(1),null);
...
(zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2(G__27888_27908,G__27889_27909) : zero.frontend.re_frame.reg_event_db.call(null,G__27888_27908,G__27889_27909));
var G__27894_27910 = new cljs.core.Keyword("header","current-theme","header/current-theme",-1526640668);
var G__27895_27911 = (function (db,_){
...
(zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2(G__27894_27910,G__27895_27911) : zero.frontend.re_frame.reg_sub.call(null,G__27894_27910,G__27895_27911));
var G__27896_27912 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","set-language","header/set-language",-464045556),new cljs.core.Keyword(null,"hu","hu",-1762884758)], null);
(zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1(G__27896_27912) : zero.frontend.re_frame.dispatch.call(null,G__27896_27912));
var G__27897_27913 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","set-theme","header/set-theme",1813110040),new cljs.core.Keyword(null,"light","light",1918998747)], null);
(zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1(G__27897_27913) : zero.frontend.re_frame.dispatch.call(null,G__27897_27913));
...
var G__27898_27914 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","set-language","header/set-language",-464045556),new_language], null);
(zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1(G__27898_27914) : zero.frontend.re_frame.dispatch.call(null,G__27898_27914));
...
var G__27899_27915 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","set-theme","header/set-theme",1813110040),new_theme], null);
(zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1(G__27899_27915) : zero.frontend.re_frame.dispatch.call(null,G__27899_27915));
...
var current_language = (function (){var G__27900 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","current-language","header/current-language",-2030560560)], null);
return (zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1(G__27900) : zero.frontend.re_frame.subscribe.call(null,G__27900));
})();
var current_theme = (function (){var G__27901 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","current-theme","header/current-theme",-1526640668)], null);
return (zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1(G__27901) : zero.frontend.re_frame.subscribe.call(null,G__27901));
})();
...
var current_theme = (function (){var G__27902 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("header","current-theme","header/current-theme",-1526640668)], null);
return (zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1(G__27902) : zero.frontend.re_frame.subscribe.call(null,G__27902));
})();
var theme_colors = ui.theme.get_theme_colors(cljs.core.deref(current_theme));
