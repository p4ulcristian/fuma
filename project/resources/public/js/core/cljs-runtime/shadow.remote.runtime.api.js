...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18675 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_18675(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_18676 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_18676(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_18678 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_18678(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_18682 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_18682(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18712 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_18712(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18722 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_18722(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__18671,callback){
var map__18672 = p__18671;
var map__18672__$1 = cljs.core.__destructure_map(map__18672);
var input = map__18672__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18672__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18672__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
