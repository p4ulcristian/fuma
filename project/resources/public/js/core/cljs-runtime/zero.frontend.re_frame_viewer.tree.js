...
}catch (e20510){if((e20510 instanceof Error)){
var e = e20510;
...
return cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20513_SHARP_){
if(clojure.string.starts_with_QMARK_(p1__20513_SHARP_,":")){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$2(p1__20513_SHARP_,(1)));
} else {
return p1__20513_SHARP_;
}
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__20512_SHARP_){
return (!(cljs.core.empty_QMARK_(p1__20512_SHARP_)));
...
var G__20514_20543 = new cljs.core.Keyword("tree-viewer","expanded-paths","tree-viewer/expanded-paths",166433203);
var G__20515_20544 = (function (db,_){
...
(zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2(G__20514_20543,G__20515_20544) : zero.frontend.re_frame.reg_sub.call(null,G__20514_20543,G__20515_20544));
var G__20516_20545 = new cljs.core.Keyword("tree-viewer","path-input","tree-viewer/path-input",756319277);
var G__20517_20546 = (function (db,_){
...
(zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2(G__20516_20545,G__20517_20546) : zero.frontend.re_frame.reg_sub.call(null,G__20516_20545,G__20517_20546));
var G__20518_20547 = new cljs.core.Keyword("tree-viewer","current-path","tree-viewer/current-path",179751951);
var G__20519_20548 = (function (db,_){
...
(zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_sub.cljs$core$IFn$_invoke$arity$2(G__20518_20547,G__20519_20548) : zero.frontend.re_frame.reg_sub.call(null,G__20518_20547,G__20519_20548));
var G__20520_20549 = new cljs.core.Keyword("tree-viewer","toggle-path","tree-viewer/toggle-path",-1380839925);
var G__20521_20550 = (function (db,p__20522){
var vec__20523 = p__20522;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20523,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20523,(1),null);
...
(zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2(G__20520_20549,G__20521_20550) : zero.frontend.re_frame.reg_event_db.call(null,G__20520_20549,G__20521_20550));
var G__20526_20551 = new cljs.core.Keyword("tree-viewer","set-path-input","tree-viewer/set-path-input",1488176391);
var G__20527_20552 = (function (db,p__20528){
var vec__20529 = p__20528;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20529,(0),null);
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20529,(1),null);
...
(zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2 ? zero.frontend.re_frame.reg_event_db.cljs$core$IFn$_invoke$arity$2(G__20526_20551,G__20527_20552) : zero.frontend.re_frame.reg_event_db.call(null,G__20526_20551,G__20527_20552));
...
var G__20532 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("tree-viewer","toggle-path","tree-viewer/toggle-path",-1380839925),path], null);
return (zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1(G__20532) : zero.frontend.re_frame.dispatch.call(null,G__20532));
...
var G__20533 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("tree-viewer","set-path-input","tree-viewer/set-path-input",1488176391),path_string], null);
return (zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.dispatch.cljs$core$IFn$_invoke$arity$1(G__20533) : zero.frontend.re_frame.dispatch.call(null,G__20533));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),zero.frontend.re_frame_viewer.tree.tree_value_container_style()], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (idx,p__20534){
var vec__20535 = p__20534;
var child_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20535,(0),null);
var child_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20535,(1),null);
...
var expanded_paths = cljs.core.deref((function (){var G__20538 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("tree-viewer","expanded-paths","tree-viewer/expanded-paths",166433203)], null);
return (zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1 ? zero.frontend.re_frame.subscribe.cljs$core$IFn$_invoke$arity$1(G__20538) : zero.frontend.re_frame.subscribe.call(null,G__20538));
})());
